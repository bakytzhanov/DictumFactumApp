...
public class RawActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(RawActivity.this));
                ...
                if (user1.getLawyer_status().equals("lawyer")) {
                    ...
                    reference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            userAdapter = new UserAdapter(RawActivity.this, mUsers, false);
